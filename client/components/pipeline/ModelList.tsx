            ...
            {sorted.map((o) => {
              ...
              return (
                <div
                  ...
                  data-order-id={o.id}
                  data-parent-id={o.parentId ?? ""}
                  className={`${bg} ${viewMode === "cards" ? "rounded-lg p-4 space-y-3 shadow-sm" : "rounded-sm py-2 px-3 space-y-1"} border border-gray-200 dark:border-gray-800 w-full ${bg ? "" : "bg-white dark:bg-gray-900"}`}
                >
