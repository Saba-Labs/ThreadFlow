            ...
            {sorted.map((o) => {
              ...
              return (
                <div
                  ...
                  data-order-id={o.id}
                  data-parent-id={o.parentId ?? ""}
                  className={`${bg} ${viewMode === "cards" ? "rounded-lg p-4 space-y-3 shadow-sm border border-gray-200 dark:border-gray-800" : "py-2 -mx-4 px-4 pr-0 space-y-1"} w-full ${bg ? "" : "bg-white dark:bg-gray-900"}`}
                >
