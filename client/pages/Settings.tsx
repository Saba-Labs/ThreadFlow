  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <div className="relative border-b border-slate-200/60 backdrop-blur-xl bg-white/80">
        <div className="max-w-full sm:max-w-6xl mx-auto px-0 sm:px-0 lg:px-0 py-2 sm:py-6">
      ...
      {/* Content Section */}
      <div className="relative max-w-full sm:max-w-6xl mx-auto px-0 sm:px-0 lg:px-0 py-2 sm:py-4 space-y-4">
        {/* Appearance Section */}
